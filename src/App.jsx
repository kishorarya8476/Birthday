    ...
    <div className="app">
      ...
      >
        <section className="hero">
          <h1 id="heroTitle">
            {birthdayReached ? (
              <>
                Happy Birthday <span className="highlight">Neelam (Neelu)</span> 🎂
              </>
            ) : (
              <>
                Counting down to <span className="highlight">Neelam (Neelu)'s</span>{" "}
                special day 🎂
              </>
            )}
          </h1>
          <p>Wish you all the  best wishes for your life, May you get all the happiness you deserve.💗</p>
        </section>
      ...
      >
        ...
        <section className="final">
          <h2 className="final-message">💖 Forever Yours — Kishor 💖</h2>
          <p className="final-subtitle">Be the best do the best spread love ✨</p>
        </section>
      </div>
